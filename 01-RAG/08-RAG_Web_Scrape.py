...
persistent_directory = os.path.join(db_dir, "chroma_db_microsoft")

# Step 1: Scrape the content from microsoft.com using WebBaseLoader
...
query = "What new products are announced on microsoft.com?"
